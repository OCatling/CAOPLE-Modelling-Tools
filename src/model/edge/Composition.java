 ...
 * @author Oliver
 */
public class Composition extends Edge{
    private static final BasicStroke STROKE = new BasicStroke(3);
    private static final Color ARROW_FILL = Color.BLACK;
    
    public Composition(double x1, double y1, double x2, double y2) {
        super(x1, y1, x2, y2);
    }
    
    public Composition(float x1, float y1, float x2, float y2){
        super(x1, y1, x2, y2);
    }

    @Override
    public BasicStroke getStroke() {
        return Composition.STROKE;
    }
    
    @Override
    public Color getArrowFill() {
        return Composition.ARROW_FILL;
    }
